...
<div class="tab-container uk-panel uk-card ">
    ...
    <ul class="uk-switcher uk-margin" id="<?php echo $tabsId; ?>">
        <li id="tab-text">
            ...
            <?php if ($this->checkPosition('image')) : ?>
                <div class="item-middle-container uk-width-1-2@m item-image uk-align-<?php echo $align; ?>">
            ...
            <?php if ($this->checkPosition('price')) : ?>
                <div class="item-middle-container uk-width-1-2@m item-price uk-align-left">
