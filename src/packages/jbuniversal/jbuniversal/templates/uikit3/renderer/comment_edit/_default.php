...
<div id="edit" class="" style="display:none">
    ...
    <form class="style short uk-form" method="post" action="<?php echo $this->app->link(array('controller' => 'comment', 'task' => 'edit')); ?>">
        ...
        <div class="actions uk-form-row">
            <input name="submit" type="submit" value="<?php echo JText::_('Save comment'); ?>" accesskey="s" class="uk-button-default uk-button-default-success" />
            <a class="comment-cancelEdit uk-button-default uk-button-default-danger" href="#edit"><?php echo JText::_('Cancel'); ?></a>
        </div>
