...
if (!empty($items)) {
    ...
    if ((int)$params->get('cancel_show', 1)) {
        echo '<a rel="nofollow" class="jsEmptyCart empty-cart uk-button uk-button-danger" href="#clean-cart">' . JText::_('JBZOO_CART_EMPTY') . '</a>';
    }

    if ((int)$params->get('link_show', 1)) {
        echo '<a rel="nofollow" class="uk-button uk-button-success add-to-cart" href="' . $basketHelper->getBasketUrl() . '">'
